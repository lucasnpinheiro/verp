...
class Cliente extends Entity {
    ...
    protected function _getUrl() {
        ...
        if (!file_exists(WWW_ROOT . 'files' . DS . 'clientes' . DS . $this->_properties['foto'])) {
            return \Cake\Routing\Router::url('/files/indisponivel.png', true);
        }

        return \Cake\Routing\Router::url(DS . 'files' . DS . 'clientes' . DS . $this->_properties['foto'], true);
    }
    ...
    protected function _getPath() {
        ...
        return WWW_ROOT . 'files' . DS . 'clientes' . DS . $this->_properties['foto'];
    }
