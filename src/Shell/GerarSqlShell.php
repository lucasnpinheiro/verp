...
class GerarSqlShell extends Shell {
    ...
    public function dados() {
        ...
        /* $sql['eventos_tipos'] = implode("\n ", $this->findDados('eventos_tipos', [], 'REPLACE'));
          $sql['tipos_empresas'] = implode("\n ", $this->findDados('tipos_empresas', [], 'REPLACE'));
          //$sql['conteudos_institucionais'] = implode("\n ", $this->findDados('conteudos_institucionais', [], 'REPLACE'));
          ...
          $sql['administradores_grupos'] = implode("\n ", $this->findDados('administradores_grupos', ['conditions' => ['administrador_id' => 1]], 'INSERT IGNORE'));
          $sql['usuarios_regioes'] = implode("\n ", $this->findDados('usuarios_regioes', ['conditions' => ['administrador_id' => 1]], 'INSERT IGNORE'));
