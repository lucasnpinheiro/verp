...
<div class="row">
    <div class="col-lg-4">
        <div class="card-box">
            ...
            <div class="widget-chart text-center">
                <div id="sparkline1"><canvas width="364" height="165" style="display: inline-block; width: 364px; height: 165px; vertical-align: top;"></canvas></div>
    ...
    <div class="col-lg-4">
        <div class="card-box">
            ...
            <div class="widget-chart text-center">
                <div id="sparkline2"><canvas width="205" height="165" style="display: inline-block; width: 205px; height: 165px; vertical-align: top;"></canvas></div>
                <ul class="list-inline m-t-15">
                    <li>
                        <h5 class="text-muted m-t-20">Target</h5>
                        <h4 class="m-b-0">$1000</h4>
